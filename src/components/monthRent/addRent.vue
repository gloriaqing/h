		...
		<div style="padding: 30px;">
			<div class="form-group">
				...
				<div class="col-sm-10 deHeight">
        			...
        			<DatePicker type="date" placeholder="选择日期" @on-change="getInVa" v-model="firstValue" style="width:100%;display: block;font-size: 15px"></DatePicker>
			...
			<div class="form-group">
				...
				<div class="col-sm-10 monthDate deHeight">
					<img src="../../assets/img/images/plus (1).svg" class="addImg" style="width: 22px;z-index: 100;" @click='add' />
					<input type="text" style="background: #fff;padding: 6px 27px;" class="form-control chooseDate" @blur="isibles" v-model="getNum" @click="pickMonth" placeholder="请选择租期时间" />
